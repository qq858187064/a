/*pw:设计稿宽度，scale：scale px是1rem */
export default function rem(pw,scale){
    var h=document.documentElement,
    rw=document.body.clientWidth||h.clientWidth;//document.documentElement.getBoundingClientRect().width
    h.style.fontSize=rw/pw*scale+"px";
    var resizeEvt = 'orientationchange' in window ? 'orientationchange' : 'resize';
    window['on'+resizeEvt]=re;
    }
    var sizing = null;   
   function re(){
        if(sizing == null)
